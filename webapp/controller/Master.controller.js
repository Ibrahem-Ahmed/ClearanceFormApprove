sap.ui.define([
	...
	return Controller.extend("ClearanceFormApprove.controller.Master", {
		...
		GoToLineItem: function(oEvent){	
			...
			var SelectedItemCode = oEvent.getSource().getBindingContext().getProperty("ItemCode");
			
			
			oRouter.navTo("Details",{ClNum: SelectedClNum, ItemCode: SelectedItemCode});
		}

		/**
		 * Similar to onAfterRendering, but this hook is invoked before the controller's View is re-rendered
		 * (NOT before the first rendering! onInit() is used for that one!).
		 * @memberOf ClearanceFormApprove.view.Master
		 */
